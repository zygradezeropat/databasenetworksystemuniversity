                                            ...
                                            <div class="card border-end">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <h6 class="text-dark">Bachelor of Sciences in Information Technology</h6>
                                                            <div class="d-inline-flex align-items-center">
                                                                <h2 class="text-dark mb-1 font-weight-medium">
                                                                    <?php echo $conn->query("SELECT * FROM students WHERE program_id = 5")->num_rows; ?>
                                                                </h2>
                                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card border-end">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <h6 class="text-dark">Bachelor of Sciences in Information System</h6>
                                                            <div class="d-inline-flex align-items-center">
                                                                <h2 class="text-dark mb-1 font-weight-medium">
                                                                    <?php echo $conn->query("SELECT * FROM students WHERE program_id = 6")->num_rows; ?>
                                                                </h2>
                                                            </div>
