                                            ...
                                            <div class="card border-end">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <h6 class="text-dark">Bachelor of Arts in Communication</h6>
                                                            <div class="d-inline-flex align-items-center">
                                                                <h2 class="text-dark mb-1 font-weight-medium">
                                                                    <?php echo $conn->query("SELECT * FROM students WHERE program_id = 12")->num_rows; ?>
                                                                </h2>
                                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card border-end">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <h6 class="text-dark">Bachelor of Secondary Education Major in English</h6>
                                                            <div class="d-inline-flex align-items-center">
                                                                <h2 class="text-dark mb-1 font-weight-medium">
                                                                    <?php echo $conn->query("SELECT * FROM students WHERE program_id=13")->num_rows; ?>
                                                                </h2>
                                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card border-end">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <h6 class="text-dark">Bachelor of Secondary Education Major in Mathematics</h6>
                                                            <div class="d-inline-flex align-items-center">
                                                                <h2 class="text-dark mb-1 font-weight-medium">
                                                                    <?php echo $conn->query("SELECT * FROM students WHERE program_id = 14")->num_rows; ?>
                                                                </h2>
                                                            </div>
                                                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">out of 200 students</h6>
                                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card border-end">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <h6 class="text-dark">Bachelor of Secondary Education Major in Science</h6>
                                                            <div class="d-inline-flex align-items-center">
                                                                <h2 class="text-dark mb-1 font-weight-medium">
                                                                    <?php echo $conn->query("SELECT * FROM students WHERE program_id = 16")->num_rows; ?>
                                                                </h2>
                                                            </div>
                                                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">out of 200 students</h6>
                                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card border-end">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <h6 class="text-dark">Bachelor of Technology and Livelihood Education</h6>
                                                            <div class="d-inline-flex align-items-center">
                                                                <h2 class="text-dark mb-1 font-weight-medium">
                                                                    <?php echo $conn->query("SELECT * FROM students WHERE program_id = 15")->num_rows; ?>
                                                                </h2>
                                                            </div>
                                                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">out of 200 students</h6>
                                                        </div>
