                                            ...
                                            <div class="card border-end">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <h6 class="text-dark">Bachelor of Science in Agroforestry</h6>
                                                            <div class="d-inline-flex align-items-center">
                                                                <h2 class="text-dark mb-1 font-weight-medium">
                                                                    <?php echo $conn->query("SELECT * FROM students WHERE program_id = 4")->num_rows; ?>
                                                                </h2>
                                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card border-end">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <h6 class="text-dark">Bachelor of Science in Fisheries and Aquatic Sciences</h6>
                                                            <div class="d-inline-flex align-items-center">
                                                                <h2 class="text-dark mb-1 font-weight-medium">
                                                                    <?php echo $conn->query("SELECT * FROM students WHERE program_id = 1")->num_rows; ?>
                                                                </h2>
                                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card border-end">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <h6 class="text-dark">Bachelor of Science in Marine Biology</h6>
                                                            <div class="d-inline-flex align-items-center">
                                                                <h2 class="text-dark mb-1 font-weight-medium">
                                                                    <?php echo $conn->query("SELECT * FROM students WHERE program_id = 2")->num_rows; ?>
                                                                </h2>
                                                            </div>
                                                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">out of 200 students</h6>
                                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card border-end">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <h6 class="text-dark">Bachelor of Science in Food Technology</h6>
                                                            <div class="d-inline-flex align-items-center">
                                                                <h2 class="text-dark mb-1 font-weight-medium">
                                                                    <?php echo $conn->query("SELECT * FROM students WHERE program_id = 3")->num_rows; ?>
                                                                </h2>
                                                            </div>
                                                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">out of 200 students</h6>
                                                        </div>
